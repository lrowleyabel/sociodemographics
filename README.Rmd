...
This is an R package collecting a few functions for dealing with socio-demographic variables. It is currently under development.
...
This is a basic example which shows how to use the ```order_age_groups``` function:
