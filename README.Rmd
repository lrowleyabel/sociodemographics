...
This is a simple R package collecting a few functions that facilitate common tasks when dealing with socio-demographic variables. It is currently under development and so has only a couple of functions.
...
```{r example, out.width="75%", dpi=1000, warning=FALSE, message=FALSE}
